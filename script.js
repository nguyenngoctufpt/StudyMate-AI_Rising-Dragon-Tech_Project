/* --- style.css (Giữ nguyên các phần đã có, chỉ kiểm tra lại) --- */

/* Các biến màu - Giữ nguyên */
:root {
    --primary-color: #2196F3;
    --primary-dark-color: #1976D2;
    --primary_light_color: #BBDEFB;
    --accent-color: #FF4081;
...
.category-link { /* Đảm bảo link bao bọc category-card */
...
.category-card {
    ...
    height: 100%; /* Đảm bảo chiều cao full cho grid */
}
...
.primary-button {
    ...
    border-radius: 12px;
    padding: 15px 20px;
    font-size: 18px; /* Đã sửa sp thành px */
    font-weight: bold;
    font-family: 'Inter', sans-serif;
    font-weight: 500;
    width: 100%;
...
@media (max-width: 400px) {
    ...
    .filter-select {
        font-size: 13px;
        padding: 8px 10px;
        background-size: 12px; /* Kích thước mũi tên nhỏ hơn */
    }
...
@media (max-width: 320px) {
    ...
    .filter-select {
        font-size: 12px;
        padding: 6px 8px;
        background-size: 10px; /* Kích thước mũi tên rất nhỏ */
    }
    .resource-results .resource-card {
        padding: 10px;
        gap: 6px;
